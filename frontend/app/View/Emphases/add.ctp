<button type="button" class="close" id="btnEmphasisSaveCancel" aria-hidden="true">×</button>
<div class="emphases form">
<?php echo $this->Form->create('Emphasis', array('class' => 'form-horizontal')); ?>
	<fieldset>
		<legend><?php echo __('Add Emphasis'); ?></legend>
...
<?php echo $this->Form->end(array('label' => __('Save'), 'id' => 'btnEmphasisAddSave', 'class' => 'btn btn-small pull-right', 'disabled' => true)); ?>
</div>
